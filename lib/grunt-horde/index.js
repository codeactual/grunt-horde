...
/**
 * Add a base config module.
 *
 * - Client project can then extend/overwrite the base.
 * - Module payloads are merged recursively to form the base, last wins.
 *
 * Usage:
 *
...
GruntHorde.prototype.loot = function(name) {
  this.base = mergeDeep(this.loot, this.requireConfigModule(name));
};
